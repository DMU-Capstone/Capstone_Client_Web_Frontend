...
export const InsightPage: React.FC = () => (
    <div className="grid gap-6 lg:grid-cols-2">
        ...
        <section className="rounded-2xl bg-slate-800/60 p-4 lg:col-span-2">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
                ...
                <ul className="space-y-2 text-sm text-slate-300">
                    {Array.from({length:6}).map((_,i) => (
                        <li key={i} className="rounded-xl bg-slate-900/60 px-3 py-2 border border-slate-700">25/09/{10-i} 사장님이 친절하고 서비스가 좋았어요</li>
                    ))}
                </ul>
            </div>
        </section>
