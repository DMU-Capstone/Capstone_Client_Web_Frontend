...
const EyeIcon = () => (
  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="#ACACAC">
        ...
        <nav className="ml-auto flex items-center gap-4">
          <button
            ...
            className={`group flex items-center px-3 py-4 rounded-xl text-sm transition-all duration-300 bg-[#41474D] hover:bg-[#41474D] hover:max-w-[160px] overflow-hidden
                            ${
                              page === "general"
                                ? "bg-[#41474D] text-white max-w-[160px]"
                                : "text-slate-300"
                            }`}
          >
            <GraphIcon />
            <span
              className={`whitespace-nowrap overflow-hidden translate-all duration-300 opacity-0 group-hover:opacity-100 group-hover:w-auto text-[#ACACAC]
                                ${
                                  page === "general"
                                    ? "opacity-100"
                                    : "opacity-0 w-0"
          ...
          >
            ...
            <span
              className={`whitespace-nowrap overflow-hidden transition-all duration-300 opacity-0 max-w-0 group-hover:opacity-100 group-hover:max-w-[140px] text-[#ACACAC]`}
            >
              PDF로 다운로드
            </span>
          </button>
